...
const registerController = async (req, res) => {
  try {
    ...
    if (req.body.password === req.body.passwordConfrim) {
      ...
      const mailOptions = {
        from: "E-commerce <rakibulanas777@gmail.com>",
        to: req.body.email,
        subject: "OTP for Email Verification",
        html: `
    <p>Hello,</p>
    <p>Thank you for registering with  assesment. To complete your email verification, please use the following One-Time Password (OTP):</p>
